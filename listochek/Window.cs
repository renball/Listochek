    ...
    public class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
           ...
           // GL.Enable(EnableCap.DepthTest);
            ...
            _specularMap = Texture.LoadFromFile("Resources/container2.png");
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            var model = Matrix4.Identity * Matrix4.CreateRotationX((float)MathHelper.DegreesToRadians(_time)) * Matrix4.CreateTranslation(xv,yv,zv);
